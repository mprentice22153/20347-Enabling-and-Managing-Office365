...
11. On the  **Office 365** home page, click **Admin**. Click  **Go to the old admin center** to switch to previous Office365 admin center.

12. In the  **Office 365 admin center**, in the left panel, click  **SERVICE SETTINGS**, and then click  **User software**.
...
In  **File Explorer**, double-click  **C:\Office16**. 

 Right-click **configuration.xml**, and click  **Copy**. Right click again and click  **Paste**. 
