...
2. Connect to  **http://portal.office.com**, and then sign in as  **holly@adatumyyxxxxx.onmicrosoft.com**, replacing  *yyxxxxx* with your unique Adatum number, and with the password **Pa55w.rd**.
...
19. Sign in as  **Francisco@adatumyyxxxxx.hostdomain.com** by using the password **Pa55w.rd**.
