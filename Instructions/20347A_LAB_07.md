...
5. Send a message to  **Monica** to test the moderation rule.
...
4. Review the most recent message sent from Francisco to Monica , and then verify that the message was sent for moderation.
...
3. Associate the  **Limited features** Outlook Web App policy with **Sallie McIntosh**.

4. In Outlook, create a new message for  **Sallie McIntosh,** and the attach the C:\Windows\Logs\DISM\dism.log file.

5. On LON-CL2, sign out of Outlook on the web, and then sign in again as  **Sallie@yourdomain.hostdomain.com** with the password **Pa55w.rd**.

6. Verify that Sallie is unable to access the attachment in the new message.
