...
1. Use Microsoft Edge to sign in to Exchange admin center as  **Holly@Adatumyyxxxxx.hostdomain.com**, where *yyxxxxx* is your unique Adatum number, with the password of **Pa55w.rd**.
...
3. On LON-CL2, use Microsoft Edge to sign in to Outlook on the web as  **Francisco@Adatumyyxxxxx.hostdomain.com**, where *yyxxxxx* is your unique Adatum number, with the password **Pa55w.rd**.
...
5. On LON-CL2, sign out of Outlook on the web, and then sign in again as  **Kendra@Adatumyyxxxxx.hostdomain.com**, where *yyxxxxx* is your unique Adatum number, with the password **Pa55w.rd**.
