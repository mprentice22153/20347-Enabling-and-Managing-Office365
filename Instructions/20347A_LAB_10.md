...
1. On  **LON-CL1**, open Microsoft Edge, connect to  **https://portal.office.com**, and then sign in as Holly Dickson.
...
2. Assign  **Holly Dickson** as the group owner, and **Beth** **Burke** as a group member.
...
4. Create a new conversation in the group with Holly Dickson.
