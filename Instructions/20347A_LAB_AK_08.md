...
1. To verify the push notification settings, type the following command, and then press Enter:

  ```
  Get-CSPushNotificationConfiguration
  ```

2. To allow users to communicate with public Skype users, type the following command, and then press Enter:

  ```
  Set-CsTenantFederationConfiguration -AllowPublicUsers $True
  ```

3. To allow users to communicate with federated partners, type the following command, and then press Enter:

  ```
  Set-CsTenantFederationConfiguration -AllowFederatedUsers $True
  ```

4. To enable communication with all federated partners except for litware.com, type the following commands, and then press Enter after each command:
...
1. Scroll back to the top of the window, and then click  **Create**.

2. In the Skype Meeting Broadcast window, click  **Create Outlook invitation**,  **Save**, and then click  **Open**.

3. If the  **How do you want to open this file**? window appears, ensure that  **Outlook 2016** is selected, and click **OK**. 

4. In the Test broadcast meeting -Meeting window, click  **Send Update**.
...
14. In Outlook, click the broadcast meeting request from Holly Dickson, click  **Accept**. 
