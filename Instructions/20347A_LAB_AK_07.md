...
26. In the  **To** field, type **Monica**.
...
6. Double-click the message sent from Francisco to Monica.
...
6. Click  **recipients**, click ** mailboxes,** click **Sallie McIntosh**, and then click  **Edit**.

7. In the Sallie McIntosh window, click  **mailbox features**.
...
10. In the Sallie McIntosh window, click  **Save**.
...
13. In the new email window, in the  **To** box, type **Sallie@yourdomain.hostdomain.com** and then click ** Check Names**.
...
18. On LON-CL2, in Outlook on the web, sign out, and then sign in again as  **Sallie@yourdomain.hostdomain.com** with the password **Pa55w.rd**.
