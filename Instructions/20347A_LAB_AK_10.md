...
2. Sign in as  **holly@Adatumyyxxxxx.hostdomain.com** (where Adatumyyxxxxx.hostdomain.com is your unique Adatum domain name) with the password  **Pa55w.rd**.
...
21. In the  **Monitor Keywords** page, type **holly@Adatumyyxxxxx.hostdomain.com** in the **Email Address** field.
