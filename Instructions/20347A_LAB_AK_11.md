...
19. On the the  **Customize the types of content you want to protect** page, click  **Next**.
...
22. On the **Scan for IP address** page, verify that the **Status** is **On**, and then click **Close**
