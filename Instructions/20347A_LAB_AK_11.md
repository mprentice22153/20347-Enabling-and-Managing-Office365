...
15. Unser **Actions**, click  **Add an action**, and then select  **Restrict access to the content**. 
...
17. Under **Incident reports**, enable the option to  **Use email incident reports to notify you when a policy match occurs.** and then click **Save**. 

18. On the the  **Customize the types of content you want to protect** page, click  **Next**.

19. On the  **Do you want to turn on the policy or test things out first?** page, select **Yes, turn it on right away** and then click **Next**.

20. On the  **Review your settings** page, verify your settings, and then click **Create**.

21. On the **Scan for IP address** page, verify that the **Status** is **On**, and then click **Close**
