...
1. Click  **add**, and then click  **ok**. Click  **Save**.

2. Close the Retention Policies window.

3. On the  **Retention** page, click **Assign retention policies to mailboxes**.

4. On the  **Assign Retention Policies to Mailboxes** page, click **ChristieThomas**, and then click  **Edit**.

5. On the  **Assign Retention Policy to Christie Thomas** page, click **Research MRM Policy**, and then click  **Save**.
