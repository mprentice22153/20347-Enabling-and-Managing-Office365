...
1. On LON-CL1, open Microsoft Edge, and then sign in to 
        [https://portal.office.com](https://portal.office.com)
       as  **holly@Adatumyyxxxxx.hostdomain.com**.
...
- In the retention area of the Security &amp; Compliance Center, create the following retention tags for your organization:
...
2. Verify that Beth does not have permission to configure SharePoint Online deletion settings. Close Microsoft Edge.

3. Open Microsoft Edge, and then connect to https://protection.office.com as  **holly@Adatumyyxxxxx.hostdomain.com**.

4. Access the Retention page, and then select the option to manage document deletion policies for SharePoint Online and OneDrive for Business.
...
Create a new rule named  **Delete Messages at 7 years** that will permanently delete messages seven years after they were created.

Set the new rule as the default rule.

6. On the  **Compliance Policy Center** page, click **Policy Assignments for Site Collections**. 

7. Apply  **Marketing Document Policy** to the Marketing site collection, and then mark the policy as mandatory.
...
Make sure that the search locations include Francisco Chaves's mailbox and the  **https://adatumyyxxxxx.sharepoint.com/sites/AcctsProj/** site collection

Configure the policy to search for the word  **Contract**.

Configure the policy to retain content for seven years. 
...
2. Send a new email to your new Microsoft account that you created for this course, with a subject of  **Server IP address** and a message body of **My IP is192.168.1.15**.
