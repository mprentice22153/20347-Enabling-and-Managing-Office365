...
4. Change the domain portion of Holly Spencer's account to  **@adatumyyxxxxx.hostdomain.com**.

5. Close Internet Explorer, open it again, and connect to the Office 365 admin center. Sign in as  **Holly@adatumyyxxxxx.hostdomain.com** using the password **Pa55w.rd**.

6. From the Office 365 admin center, download and install Azure AD Connect with Customized Settings. You will need to configure the security settings for the Internet zone to enable file downloads.
