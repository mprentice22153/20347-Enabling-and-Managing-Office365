...
6. For Step 2, in the  **Create your user ID** page, you have to create a unique domain for the Company name to use in the course. Use the **_Adatumyyxxxxx_** name provided in the lab interface. For the rest of the fields, use the following information:
