...
11. Navigate to **users/Active Users**. Click on the "**More**" button and select "Directory Synchronization".

12. Click on "**Go to the Directory Synchronization Management**" (if activation was not yet completed this link would say "Go to the DireSYnc Readyness wizard")

13. To the right of **Active Directory synchronization enabled**, verify that there is a **True** mention.
...
20. In the Office365 admin center, in the left side menu, click  **USERS**, and then click  **Active users**.
