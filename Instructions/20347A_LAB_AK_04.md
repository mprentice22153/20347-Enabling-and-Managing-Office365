...
13. Click on the "**More**" button and select "Directory Synchronization".

14. Click on "**Go to the Directory Synchronization Management**" 

  > If activation was not yet completed this link will say **Go to the DireSync readiness wizard**.
