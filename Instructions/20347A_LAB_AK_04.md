...
9. In the  **Password** box, type **Pa55w.rd**, and then click  **Sign in**.
...
15. Click  **Set as primary** and then read the warning and click **Save**.
...
21. Sign in as  **holly@Adatumyyxxxxx.hostdomain.com**, using the password  **Pa55w.rd**.

22. In the Office365 admin center, in the left side menu, click  **Health**, and then click  **Directory Synch Status**.

23. Under the  **Directory Sync client version**, click  **Upgrade**.
...
24. On the  **Microsoft Azure Active** **Directory Connect** download page in Internet Explorer, click **Download**.

25. In the Internet Explorer notification bar, click  **Save as**, browse to  **C:\\Labfiles**, and then click  **Save**. If the LabFiles folder does not exist, create it.

26. When the download has completed, in the Internet Explorer notification bar, click  **Open folder**.

27. In  **File Explorer**, right-click  **AzureADConnect.msi**, and then click  **Install**. Click  **Run**.

28. In the  **Microsoft Azure Active Directory Connect** wizard, on the **Welcome** page, click **I agree to the license terms and privacy notice**, and then click  **Continue**.

29. On the  **Express Settings** page, click **Customize**.

30. Leave the Microsoft Azure Active Directory Connect wizard open for the next task.
...
4. On the  **Connect your directories** page, click **Add Directory**.
...
>  18. For  **FlowType**, select  **Constant**.
>  19. For  **Target Attribute**, select  **cloudFiltered**.
>  20. In the  **Source** text box, type **True**. 
>  21. Click **Save**.
>  22. In  **Synchronization Rules Editor**, select the rule  **In from AD - User Join** and click **Edit**.
>  23. In the **Edit Reserved Rule** dialog, click **No**.
>  24. In the **Edit inbound synchronization rule** dialog, clear the option **Disabled**, click **Save**, and click **Yes** to confirm.
