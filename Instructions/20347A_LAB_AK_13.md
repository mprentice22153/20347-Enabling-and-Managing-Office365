...
5. On LON-DC1, open Internet Explorer and connect to  **https://adfs.Adatumyyxxxxx.hostdomain.com/adfs/fs/federationserverservice.asmx**, replacing Adatumyyxxxxx with your unique Adatum domain name, and then press Enter. 
...
3. Sign in as **holly@adatumyyxxxxx.hostdomain.com** with the password **Pa55w.rd**.
